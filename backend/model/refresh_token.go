...
// GetByID 根据ID获取刷新令牌
func (dao *RefreshTokenDAO) GetByID(id uint64) (*RefreshToken, error) {
...
func (dao *RefreshTokenDAO) GetByUserID(userID uint64) ([]*RefreshToken, error) {
...
func (dao *RefreshTokenDAO) DeleteByUserID(userID uint64) error {
